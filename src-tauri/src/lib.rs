...
pub fn run() {
    let builder = tauri::Builder::default()
        .plugin(tauri_plugin_updater::Builder::new().pubkey("dW50cnVzdGVkIGNvbW1lbnQ6IG1pbmlzaWduIHB1YmxpYyBrZXk6IDk5NkNFRUEwM0I0NDNFMzUKUldRMVBrUTdvTzVzbVlKT002b3JEZGNKc29MSzRMUHdKK2o0YkNWY3FwZTdIYWJwcXdGNjFvOVgK").build())
