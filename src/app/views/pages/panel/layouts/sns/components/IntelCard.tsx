...
interface IntelCardProps {
  ...
  refetch: () => void;
  onDataClick?: (keyword: string, searchClass: string) => void; // Callback opcional para manejar clicks sin navegar
}
...
export const IntelCard: FC<IntelCardProps> = ({ intel, onOpenLeakedModal, refetch, onDataClick }) => {
  ...
  const handleUsernameClick = (username: string) => {
    ...
    if (onDataClick) {
      onDataClick(cleanUsername, 'username');
    } else {
  ...
  const handleDomainClick = (domain: string) => {
    ...
    if (onDataClick) {
      onDataClick(cleanDomain, '_domain');
    } else {
  ...
  const handlePasswordClick = (password: string) => {
    ...
    if (onDataClick) {
      onDataClick(cleanPassword, 'password');
    } else {
